      ...
      <div class="w-[1000px] bg-[#e8e4e6] rounded">
        ...
        <div class="body px-6 py-2 ">
          <div class="mt-3 items-center">
            <p class="font-bold mr-5 text-center text-[18px]">Form Data Guru</p>
          </div>
            ...
            <form @submit.prevent="submit">
              <div>
                ...
                <div class="flex justify-between mb-5">
                  <button class="bg-[#e16162] text-white rounded py-1 px-2 mr-1"> Simpan</button>
                </div>
              </div>
            </form>
          </div>
...
async function submit() {
  ...
  if(!dataKosong.value) {
    ...
    await axios.post('https://vue-ga-269cd-default-rtdb.asia-southeast1.firebasedatabase.app/guru.json', payload).
